...
public enum ErrorCode {
    ...
    CREDIT_CHANGE_VALUE_ERROR_TYPE(80002, "传入信用值类型不对，为数字或者数字的字符串"),
    CREDIT_UNKNOWN_ACTION_TYPE(80003, "未知Action类型"),

    MESSAGE_UNKOWN_MESSAGE_TYPE(0001, "MESSAGE_UNKOWN_MESSAGE_TYPE"),
    MESSAGE_UNKOWN_MESSAGE_STATE(70002, "MESSAGE_UNKOWN_MESSAGE_STATE"),
    MESSAGE_SENDID_NULL(70005, "MESSAGE_SENDID_NULL"),
    MESSAGE_RECEIVER_NULL(70004, "MESSAGE_RECEIVER_NULL"),
    MESSAGE_ID_NULL(70006, "MESSAGE_ID_NULL"),
    MESSAGE_UNKNOWN_ACTION_TYPE(70007, "MESSAGE_UNKNOWN_ACTION_TYPE"),

    MANUAL_REVIEW_CREATE_COMPUSID_NULL(60001, "MANUAL_REVIEW_CREATE_COMPUSID_NULL"),
    MANUAL_REVIEW_CREATE_IDCARD_NULL(60002, "MANUAL_REVIEW_CREATE_IDCARD_NULL"),
    MANUAL_REVIEW_CREATE_ALIPAY_NULL(60003),
    MANUAL_REVIEW_CREATE_FAILED_UNKNOW_ERROR(60004), SYSTEM_WRONG_PARAM_NAME_INTGER(9), MANUAL_WRONG_ACTION_TYPE(60005), MANUAL_COMPLAINT_CREATE_COMPUSID_NULL(60006), MANUAL_COMPLAINT_CREATE_IDCARD_NULL(60007), MANUAL_COMPLAINT_CREATE_FAILED_UNKNOW_ERROR(60008), MANUAL_COMPLAINT_CREATE_ORDERID_NULL(60009), MANUAL_COMPLAINT_CREATE_ORDER_ALEADY_COMPLAIN(60010), MANUAL_HADNLE_ORDERCOMPLAINT_CREDIT_WRONG_FORMAT(60011), MANUAL_COMPLAINT_HANDLE_PARAM_INTEGER_FORMAR_WRONG(60012);
